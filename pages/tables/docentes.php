                      ...
                      <tbody>
                        ...
                        <?php
                          require ("connection.php");
                            ...
                            $sql = $conn -> query("SELECT doc, tipo_doc, nom1, nom2, ape1, ape2, correo, tel, rol.nom_rol,nac,edad
                            FROM user
                            INNER JOIN rol ON user.id_rol_fk = rol.id_rol where id_rol = 2
                            ");
                            ...
                            while ($resultado = $sql->fetch_assoc()) {
                              ...
                              echo "<td style='color: blue'><a href='modificar3.php?id=" . $resultado["doc"] . "' style='color: blue;'>Modificar</a></td>";


    
                                // Eliminar
                                echo "<td style='color: red'><a href='eliminar3.php?id=" . $resultado["doc"] . "' style='color: red;'>Eliminar</a></td>";
